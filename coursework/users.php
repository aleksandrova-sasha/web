<?php
	...
	*/
	...
	$param_keys=array('level',  'email', 'fio', 'password', 'login', 'discount_value'); // названия полей в таблице БД
	$param_str=array('Уровень доступа', 'Email', 'ФИО', 'Пароль', 'Логин', 'Индивидуальная скидка, %'); // названия столбцов в таблице для отображения
	$param_ext=array(0, '`levels`.`name`', 0, 0, 0, 0); // поля для select
