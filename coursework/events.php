<?php
	...
	*/
	...
	$param_keys=array('dt',  'name', 'note', 'price'); // названия полей в таблице БД
	$param_str=array('Дата и время', 'Название сеанса', 'Описание сеанса', 'Цена билета'); // названия столбцов в таблице для отображения
	$param_ext=array(0, 0, 0, 0); // поля для select
	$param_need='dt'; // обязательные поля, без которых не сохранять данные
?>
<html>
<head>
	<meta charset="utf-8">
